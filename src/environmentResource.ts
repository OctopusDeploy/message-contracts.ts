...
export interface EnvironmentResource extends NamedResource<EnvironmentResourceLinks>, SpaceScopedResource {
...
export interface NewEnvironmentResource extends NewNamedResource, NewSpaceScopedResource {
  AllowDynamicInfrastructure?: boolean;
  Description?: string;
  ExtensionSettings?: ExtensionSettingsValues[];
  SortOrder?: number;
